...
fqi = FQI(mdp, pi, verbose = True, actions = actions, batch_size = 10, max_iterations = 60, regressor_type = ExtraTreesRegressor, **regressor_params)
...
experiment = RepeatExperiment("FQI Experiment", fqi, n_steps = 16, n_runs = 8, callback_list = callback_list, **fit_params)
